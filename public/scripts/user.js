var usrPassCheck, inputPassword, inputPasswordConfirm, inputName, inputLastName, inputAvatar, inputCalleDeEntrega, inputCiudadDeEntrega, 
inputPaisDeEntrega, inputCPDeEntrega, btnSave, form;

window.addEventListener("load",(e)=>{ 
  usrPassCheck = document.getElementById("editPassword");
  ...
  usrPassCheck.addEventListener("click",(e)=>{
      let messages = inputPassword.parentElement.getElementsByClassName("messages")[0];
      messages.innerHTML = "";
      inputPassword.value = "";
      inputPasswordConfirm.value = "";
      usrPassCheck = document.getElementById("editPassword")
      inputPassword.classList.toggle("hidden");
      inputPasswordConfirm.classList.toggle("hidden");
      inputPassword.classList.remove("has-error");
    inputPasswordConfirm.classList.remove("has-error");
  });
  
  if(usrPassCheck.checked){
    inputPassword.classList.remove("hidden","has-error");
    inputPasswordConfirm.classList.remove("hidden","has-error");
  }
